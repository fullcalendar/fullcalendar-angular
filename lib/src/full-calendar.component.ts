...
export class FullCalendarComponent
  implements AfterViewInit, DoCheck, AfterContentChecked, OnDestroy
{
  ...
  */
  ...
  constructor(private element: ElementRef, changeDetector: ChangeDetectorRef) {
  ...
  ngAfterViewInit() {
    ...
    // initialize snapshot
    this.optionSnapshot = mapHash(
      options,
      (optionVal: any, optionName: string) =>
